...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 10){
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(MainActivity.this,"Permission denied Can't open camera",Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String ankit ="6370983499";
        smsManager.sendTextMessage(ankit, null,"message",null,null);
...
//                    isCamera = true;
        ...
        button1.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                SmsManager smsManager = SmsManager.getDefault();
                smsManager.sendTextMessage("8249766641", null, "message", null, null);
